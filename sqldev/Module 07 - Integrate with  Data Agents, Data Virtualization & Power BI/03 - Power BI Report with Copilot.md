...
## Section 1: Create Semantic Model

### Task 1.1:
1. Using the navigator on the left side of the Microsoft Fabric page, **click the tile for your database**. 
...
### Task 2.1:
1. Open your workspace and seach for the new **semantic model - product_insight** in the search bar.
...
1. Click the **Create button** for any **report** you would like to create.
...
## What's next
Congratulations! You have learnt the basics of Semantic model as well as report creation from Fabric with copilot. In the next module [Sentiment Analysis with PowerBI and Translytical Taskflows in Power BI](../Module%2008%20-%20Reporting%20with%20action%20using%20Translytical%20Taskflows%20in%20Power%20BI/01%20-%20Data%20population.md) you will explore how you can write to your SQL database directly from your Reports.You will dive into the Translytical Lab—a cutting-edge feature in Power BI that blends transactional and analytical capabilities. You'll learn how users can not only analyze data but also interact with it in real time, trigger workflows, and write back to databases.